...
struct option_t{
	...
	void (*parse)(std::string const &); // Puntero a funci�n de opciones
	int flags;
};
...
class cmdline{
	...
	// sint�ctico, recibe una palabra y lo interpreta en 
	// una acci�n dependiendo su significado para el programa) 
